...
useEffect(() => {
  ...
  return (
    ...
    <Land/>
        ...
        <section className="w-full  container  xs:p-[1rem] lg:flex lg:flex-row lg:justify-between    h-full ">
...
{/*     justify-content: center;
    margin-top: 1rem; */}
          <main className="flex lg:w-[80%] flex-row flex-wrap h-full justify-center w-full mt-[1rem] mb-[3rem]">
            <ShopMain />
          </main>
        </section>
