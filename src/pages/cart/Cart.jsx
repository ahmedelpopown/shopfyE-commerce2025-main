...
const Cart = () => {
  ...
  return (
    <Layout>
      ...
      <div className="container flex flex-row flex-wrap items-start justify-between my-8 min-h-[90vh]">
        <div className="border w-[65%]">
          <div className="flex flex-row flex-wrap items-start justify-center  border-b p-[1rem]">
            <h1 className="text-base font-bold text-center col-5">product</h1>

            <div className="flex flex-row flex-wrap items-end justify-end gap-4 text-base font-bold col-6">
          ...
          {cartItems.map((item, index) => (
            <div
              key={item.id || index}
              className="flex flex-row flex-wrap items-center justify-start border-b col-12 "
            >
              <div className="flex flex-row flex-wrap items-center justify-start gap-[2rem] p-4 col-6 ">
                <Trash2
                  className="w-4 h-4 cursor-pointer"
                  onClick={() => handleRemove(item.variantId)}
                />
                <img src={item.image} className="col-2" alt={item.name} />
                <h1 className="text-sm text-textColor ">{item.name}</h1>
              </div>
              <div className="flex flex-row flex-wrap items-center justify-center gap-[2rem] col-5">
                <h1 className="col-2 text-textColor">${item.price}</h1>
                ...
                <h1 className="col-2 text-customTeal">
        ...
        <div className="flex flex-wrap gap-4 p-4 border w-[30%]">
          <div className="flex flex-row flex-wrap items-center justify-between p-2 text-2xl font-semibold border-b col-12">
            <h4 className="text-base"> product</h4>
            <h4 className="text-base"> supTotal</h4>
          </div>
          ...
          <div className="flex flex-row flex-wrap items-center justify-center p-2 border-t border-b col-12">
            ...
            <div className="flex flex-col flex-wrap items-end gap-2 col-10">
              ...
              <h2 className="text-customTeal hover:text-black">
                change address
              </h2>
            </div>
          </div>
